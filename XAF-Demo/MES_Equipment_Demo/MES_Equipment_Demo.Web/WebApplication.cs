...
namespace MES_Equipment_Demo.Web {
    // For more typical usage scenarios, be sure to check out https://docs.devexpress.com/eXpressAppFramework/DevExpress.ExpressApp.Web.WebApplication
    public partial class MES_Equipment_DemoAspNetApplication : WebApplication {
        private DevExpress.ExpressApp.SystemModule.SystemModule module1;
        private DevExpress.ExpressApp.Web.SystemModule.SystemAspNetModule module2;
        private MES_Equipment_Demo.Module.MES_Equipment_DemoModule module3;
        private MES_Equipment_Demo.Module.Web.MES_Equipment_DemoAspNetModule module4;
        ...
        static MES_Equipment_DemoAspNetApplication() {
        ...
        #endregion
        public MES_Equipment_DemoAspNetApplication() {
            InitializeComponent();
			InitializeDefaults();
        }
        ...
        private void MES_Equipment_DemoAspNetApplication_DatabaseVersionMismatch(object sender, DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
#else
