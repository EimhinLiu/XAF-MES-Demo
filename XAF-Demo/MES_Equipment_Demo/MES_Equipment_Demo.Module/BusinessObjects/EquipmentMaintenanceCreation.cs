...
{
    [DefaultClassOptions]
    [XafDisplayName("设备维修创建")]
    public class EquipmentMaintenanceCreation : BaseObject
    { // Inherit from a different class to provide a custom primary key, concurrency and deletion behavior, etc. (https://documentation.devexpress.com/eXpressAppFramework/CustomDocument113146.aspx).
        public EquipmentMaintenanceCreation(Session session)
            : base(session)
        {
        }
        ...
        private SystemUser _SystemUsers;
        ...
        public SystemUser SystemUsers
        {
            ...
            set { SetPropertyValue<SystemUser>(nameof(SystemUsers), ref _SystemUsers, value); }
        }
